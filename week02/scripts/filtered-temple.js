...
const temples = [
  // Use absolute URLs if you want, or local images in /images. Use forward slashes (/), not backslashes (\).
  {
    ...
    area: 42300,
    imageUrl: "images/512px-LDS_Laie_Hawaii_Temple_front_view.jpg",
  },
  {
    ...
    area: 72000,
    imageUrl: "images/512px-San_Diego_Temple.jpg",
  },
  {
    ...
    area: 25245,
    imageUrl: "images/512px-Bentonville_Arkansas_Temple_20230619_0928.jpg",
  },
  {
    ...
    area: 142000,
    imageUrl: "images/512px-St._George_Utah_Temple,_a_temple_of_the_Church_of_Jesus_Christ_of_Latter-Day_Saints_(LDS_Church)_in_St._George,_Utah.jpg",
  },
  {
    ...
    area: 92000,
    imageUrl: "images/512px-The_Church_of_Jesus_Christ_of_Latter-day_Saints_-_Idaho_Falls.jpg",
  },
  {
    ...
    area: 32325,
    imageUrl: "images/512px-Kansas_City_Temple.jpg",
  },
  {
    ...
    area: 61800,
    imageUrl: "images/512px-Philadelphia_Temple.jpg",
  },
  {
    ...
    area: 156558,
    imageUrl: "images/512px-Washington_DC_Temple.jpg",
  },
  {
    ...
    area: 148236,
    imageUrl: "images/temples/jordanriver.jpg",
  },
  ...
  },
  {
    ...
    area: 41010,
    imageUrl: "https://cdn.churchofjesuschrist.org/temples/rome-italy-temple/exterior.jpg",
  },
  {
    ...
    area: 21500,
    imageUrl: "https://cdn.churchofjesuschrist.org/temples/freiberg-germany-temple/exterior.jpg",
  },
];
...
function byFilter(option) {
  switch (option) {
    case "old":   // before 1900
      return t => new Date(t.dedicated).getFullYear() < 1900;
    case "new":   // after 2000
      return t => new Date(t.dedicated).getFullYear() > 2000;
    default:
      return () => true;
  }
}
...
function bySize(option) {
  switch (option) {
    case "large": // > 90,000 sq ft
      return t => t.area > 90000;
    case "small": // < 10,000 sq ft
      return t => t.area < 10000;
    default:
      return () => true;
  }
}
